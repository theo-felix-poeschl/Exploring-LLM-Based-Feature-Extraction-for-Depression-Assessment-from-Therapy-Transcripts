...
OUTPUT_FILE = Path("/home/jovyan/Exploring-LLM-Based-Feature-Extraction-for-Depression-Assessment-from-Therapy-Transcripts/OUTPUT/11_synthetic_transcripts_long.csv")
...
def build_messages(
    ...
    system_prompt = f"""
        ...
        - Do not force strict speaker alternation.
        - Consecutive entries by the same speaker are allowed if this makes the dialogue more realistic.
        - Use the nearest-neighbor examples as guidance for when speakers alternate and when one speaker produces multiple consecutive entries.
        - The generated transcript should contain approximately {neighbor_mean_n_turns} entries.
        - The transcript should resemble the conversation structure and length of the nearest-neighbor examples.
        ...
        "turns": [
            ...
            {{
            "speaker": "Participant",
            "value": "additional utterance text"
            }},
            {{
            "speaker": "Therapist",
            "value": "utterance text"
